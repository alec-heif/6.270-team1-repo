...
int umain (void) {
    ...
    printf("Hello from Team Char Broiled: the best team around!\nSpecial shoutout to the programming team, which is truly awesome. Four for you, programmers!\n\n\n");
    pause(3000);
    printf("and none for David Larson ok bye.\n\n");
    pause(5000);
    ...
    scanf("%d", &foo);
    printf("You inputed %d as your integer.\n", foo);
    pause(1000);
    printf("...but you should have inputted 69...\n");
    pause(5000);
    while(1){
        // put your code here
        printf("penis at time %lu\n", get_time());
        pause(1000);
